...
<!-- 
	게시글 수정기능을 작성하시오
	BoardController에 Post방식 요청받는 boardUpdate.do를 만든 다음
	idx와 일치하는 게시글 정보를(제목,내용 , 작성자) 수정하시오
...
<table class = "table table-bordered table-hover">
	...
	<tr>
		<td>작성자</td>
		<td><input value="<%= vo.getWriter() %>"name = "writer" type="" class="form-control" placeholder="작성자를 입력하세요."></td>
	</tr>
	<tr>
