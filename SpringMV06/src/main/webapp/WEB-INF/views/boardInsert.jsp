...
<!-- 
	...
	1. GET (=Query String)
		...
		- boardList.do?title=졸려&writer=나유진&cotents=잠와
		- 모든 요청을 할 때 따로 변경ㅎ지 않은 한 기본 요청방식은 GET방식이다.
		- 장점: 속도가 빠르다
		- 단점 : 보안에 취약하다. 보낼 데이터의 제한이 있다
	2. POST
	- 요청할 때 전달할 데이터를 패킷 바디 안에 보내는 방식
	- 보내는 데이터를 외부에서 확인 불가
	- 장점 : 보안 좋다, 많은 양의 데이터를 보낼 수 있다
...
<table class = "table table-bordered table-hover">
	...
	<tr>
		<td>작성자</td>
		<td><input name = "writer" type="" class="form-control" placeholder="작성자를 입력하세요."></td>
	</tr>
	<tr>
